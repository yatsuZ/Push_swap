...
/*   Updated: 2023/05/29 22:50:48 by yzaoui           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	cette versione verifie que tout ce qui suit est plus grand et ce qui precedent plus petit
...
void	trie_5_ou_moin(t_pile *p)
{
	...
	p2_trie_p3(p, pa_est_il_trier2(p));//faire fonction qui fais -min - 1 sinon la posinon du min
	while (p->b)
		add_into_pa(p, p->b);
